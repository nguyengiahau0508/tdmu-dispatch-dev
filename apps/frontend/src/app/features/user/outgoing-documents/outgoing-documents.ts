...
@Component({
  ...
  template: `
    <div class="outgoing-documents">
      <div class="outgoing-documents__header">
        <div class="header__group">
          <!-- <div class="header__title">
            <h2>Quản lý công văn đi</h2>
          </div> -->
      ...
      <div class="outgoing-documents__main">
        @if (filteredDocuments.length > 0) {
          ...
          <div class="empty-state">
            ...
            <h3>Không có công văn đi nào</h3>
            <p>Chưa có công văn đi nào được tạo hoặc không tìm thấy công văn phù hợp với bộ lọc.</p>
            <button class="btn btn-primary" (click)="createDocument()">
              <span class="btn-icon">+</span>
...
export class OutgoingDocuments implements OnInit {
  ...
  onEditDocument(document: Document): void {
    console.log('=== OutgoingDocuments onEditDocument ===');
