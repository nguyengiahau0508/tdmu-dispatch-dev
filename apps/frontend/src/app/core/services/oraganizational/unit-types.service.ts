...
import { ICreateUnitTypeInput, ICreateUnitTypeOuput } from "../../../features/admin/organizational/unit-types/interfaces/unit-type-create.interfaces";
import { map, Observable } from "rxjs";
import { IApiResponse, IPaginatedResponse } from "../../../shared/models/api-response.model";
import { CREATE_UNIT_TYPE_MUTATION, REMOVE_UNIT_TYPE, UPDATE_UNIT_TYPE } from "../../../features/admin/organizational/unit-types/graphql/unit-types.mutations";
import { IGetUnitTypesPaginatedInput } from "../../../features/admin/organizational/unit-types/interfaces/get-unit-types-paginated.interface";
import { IUnitType } from "../../interfaces/oraganizational.interface";
import { GET_UNIT_TYPES_QUERY } from "../../../features/admin/organizational/unit-types/graphql/unit-types.queries";
import { IUpdateUnitTypeInput, IUpdateUnitTypeOuput } from "../../../features/admin/organizational/unit-types/interfaces/unit-type-update.interface";
