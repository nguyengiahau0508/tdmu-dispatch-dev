...
export default registerAs(
  'database',
  (): IDatabaseConfig => ({
    type: (process.env.DATABASE_TYPE || 'mariadb') as IDatabaseConfig['type'],
    ...
    entities: [process.env.DATABASE_ENTITIES || join(__dirname, '/../../../**/*.entity{.ts,.js}')], // Điều chỉnh đường dẫn nếu cần
    migrations: [process.env.DATABASE_MIGRATIONS || join(__dirname, '/../../../database/migrations/*{.ts,.js}')],
