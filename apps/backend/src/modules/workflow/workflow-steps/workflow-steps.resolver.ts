...
export class WorkflowStepsResolver {
  ...
  @Query(() => [WorkflowStep], {
    name: 'workflowSteps',
    description: 'Lấy tất cả workflow steps',
  })
  findAll() {
    return this.workflowStepsService.findAll();
  }

  @Query(() => WorkflowStepPageDto, {
    name: 'workflowStepsPaginated',
    description: 'Lấy danh sách workflow steps có phân trang',
  })
  ...
  @Query(() => WorkflowStep, {
    name: 'workflowStep',
    description: 'Lấy workflow step theo ID',
  })
  ...
  @Query(() => [WorkflowStep], {
    name: 'workflowStepsByTemplate',
    description: 'Lấy workflow steps theo template ID',
  })
  findByTemplateId(
  ...
  @Query(() => [StepTypeDto], {
    ...
    description: 'Lấy danh sách các loại workflow step',
  })
  getStepTypes() {
  ...
  @Mutation(() => [WorkflowStep], {
    description: 'Di chuyển workflow step đến vị trí mới',
  })
  moveWorkflowStep(
  ...
  @Mutation(() => [WorkflowStep], {
    description: 'Sắp xếp lại thứ tự các workflow steps',
  })
